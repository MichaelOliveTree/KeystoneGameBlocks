...
namespace KeyEdit
{
    ...
    public class Simulation : Keystone.Simulation.ISimulation
    {
        ...
        private DataProcessors mIntrinsicProcessors;
        private DataProcessors mRulesProcessors; 
        ...
        public Simulation(float gravity, Game game)
        {
            ...
            mIntrinsicProcessors = new DataProcessors();
            mRulesProcessors = new DataProcessors();
        ...
        public DataProcessors IntrinsicProcessors { get {return mIntrinsicProcessors;}}
    
        public DataProcessors RulesProcessors { get { return mUserRulesProcessors;}}
